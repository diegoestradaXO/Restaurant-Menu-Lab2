...
class OrdenActivity: AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val adapter = ArrayAdapter(this,R.layout.listview_item, AppExtension.menuOrder)
        ...
        limpiar.setOnClickListener {
            AppExtension.clear()//Se borran los elementos
        ...
        override fun onItemLongClick(parent: AdapterView<*>?, view: View?, position: Int, id: Long): Boolean {
            ...
            Toast.makeText(applicationContext,"Se eliminó " + AppExtension.menuOrder[position] + " del carrito de compra",Toast.LENGTH_SHORT).show()
            AppExtension.del(position)//Se borra de la lista de Pedido
